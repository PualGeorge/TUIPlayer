...
import com.tencent.qcloud.tuikit.tuiplayer.demo.debug.GenerateTestUserSig;

import java.io.File;

import static com.tencent.qcloud.tuikit.tuiplayer.demo.debug.GenerateTestUserSig.PLAY_DOMAIN;
import static com.tencent.qcloud.tuikit.tuiplayer.demo.debug.GenerateTestUserSig.PUSH_DOMAIN;
...
public class URLUtils {
    ...
    public static String generatePushUrl(String streamId, PushType type) {
        ...
        if (type == PushType.RTC) {
            ...
            pushUrl = RTMP + PUSH_DOMAIN + File.separator + APP_NAME + File.separator + streamId + GenerateTestUserSig.getSafeUrl(streamId);
        }
        return pushUrl;
    }
